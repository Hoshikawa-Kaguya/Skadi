...
namespace SuiseiBot.DatabaseUtils.Helpers.PCRGuildBattleDB
{
    internal class GuildBattleMgrDBHelper : BaseGuildBattleDBHelper
    {
            ...
            try
            {
                ...
                if (uid == null)
                {
                    ...
                    return dbClient.Queryable<GuildBattle>()
                                   .AS(BattleTableName)
                                   .Where(i => i.Time >= SuiseiUtils.GetUpdateStamp())
                                   .OrderBy(i => i.Aid)
                                   .ToList();
                }
                else
                {
                    ...
                    return dbClient.Queryable<GuildBattle>()
                                   .AS(BattleTableName)
                                   .Where(i => i.Time >= SuiseiUtils.GetUpdateStamp() && i.Uid == uid)
                                   .OrderBy(i => i.Aid)
                                   .ToList();
                }
            }
        ...
        public Dictionary<long, int> GetTodayAtkCount()
        {
            try
            {
                ...
                return dbClient.Queryable<GuildBattle>()
                               .AS(BattleTableName)
                               .Where(attack => attack.Time   > SuiseiUtils.GetUpdateStamp() &&
        ...
        public int GetTodayAttackCount(long uid)
        {
            try
            {
                ...
                return dbClient.Queryable<GuildBattle>()
                               .AS(BattleTableName)
                               //今天5点之后出刀的
                               .Where(i => i.Uid    == uid && i.Time >= SuiseiUtils.GetUpdateStamp() &&
