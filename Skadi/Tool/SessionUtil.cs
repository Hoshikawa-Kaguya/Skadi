...
internal static class SessionUtil
{
    ...
    {
        return eventArgs.SenderInfo.Role is MemberRoleType.Admin or MemberRoleType.Owner;
    }
    ...
    {
        return eventArgs.Message.RawText.Trim().Split(' ');
    }
