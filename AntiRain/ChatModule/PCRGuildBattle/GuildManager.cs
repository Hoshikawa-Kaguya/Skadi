                                            ...
                                            PCRGuildBattleCommand commandType) //功能响应
        {
            ...
            switch (commandType)
            {
                case PCRGuildBattleCommand.DeleteGuild://删除公会
                    if(BotUtils.CheckForLength(commandArgs, 0) != LenType.Legitimate) return;
                ...
                case PCRGuildBattleCommand.CreateGuild: //建会
                    ...
                    if (BotUtils.CheckForLength(commandArgs, 1) != LenType.Illegal)
                    {
                        Server guildServer;
                        //检查输入服务器代号是否合法
                        ...
                        //根据输入参数建立公会
                        switch (BotUtils.CheckForLength(commandArgs, 2))
                        {
                ...
                case PCRGuildBattleCommand.JoinGuild: //入会
                    ...
                    var checkRet = BotUtils.CheckForLength(commandArgs, 1, QQGroup, GMgrEventArgs.Sender.Id);
                ...
                case PCRGuildBattleCommand.QuitGuild: //退会
                    ...
                    var lengthRet = BotUtils.CheckForLength(commandArgs, 1, QQGroup, GMgrEventArgs.Sender.Id);
                ...
                case PCRGuildBattleCommand.JoinAll: //一键入会
                    ...
                    foreach (GroupMemberInfo member in memberList.groupMemberList)
                    {
                        ...
                        addedQQsList.Add(member.UserId,
                                         await dbAction.JoinToGuild(member.UserId, QQGroup.Id, BotUtils.getNick(member)));
                    }
